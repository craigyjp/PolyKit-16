...
const uint8_t RESET_PINS[NUM_VOICES] = {13, 13, 13, 13};
const uint8_t RANGE_PINS[NUM_VOICES] = {16, 16, 16, 16};
const uint8_t GATE_PINS[NUM_VOICES] = {8, 9, 10, 11};
const uint8_t VOICE_TO_PIO[NUM_VOICES] = {0, 0, 0, 0};
const uint8_t VOICE_TO_SM[NUM_VOICES] = {0, 1, 2, 3};
